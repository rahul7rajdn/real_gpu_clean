#!/bin/bash
#SBATCH --job-name=real_a100_fp16_lr3e-3_sub1e-3_s3
#SBATCH --output=real_gpu_results_20251116_122625/job_logs/real_a100_fp16_lr3e-3_sub1e-3_s3_%j.out
#SBATCH --error=real_gpu_results_20251116_122625/job_logs/real_a100_fp16_lr3e-3_sub1e-3_s3_%j.err
